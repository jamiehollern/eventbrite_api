...
at https://drupal.org/project/eventbrite as the development of the module 
is far away from where it needs to be. Hopefully the code for this module 
can be merged with the "official" Eventbrite module at some point in the 
future.
